...
Il y a deux tables des symboles distinctes à gérer (cf. figure \ref{fig:architecture_parseur_xmi}), celle du parseur et celle du générateur XMI. Etant donné que le méta-modèle, pour être respecté, implique que le parseur fasse bien plus que parser mais surtout le contrôle de type car il est fortement typé, mais aussi des vérifications des portées des variables dans le programme CHIPS. \\

\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{images/architecture_parseur_xmi.png}
