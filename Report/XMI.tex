...
L'évolution de l'interpréteur réalisée au cours du stage a toutefois nécessité de faire évoluer cette architecture (cf. figure \ref{fig:architecture_situer_parseur_xmi}) afin de l'adapter au nouvel AST produit par ANTLR4 tout en conservant les principes de fonctionnement établis par les travaux antérieurs. \\
