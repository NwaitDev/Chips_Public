...
{Remarque}
{
    Le calcul de la commande du PID s'effectue avec l'équation suivante :
    \begin{equation}
        u(t) = K_p e(t) + K_i \int_{0}^{t} e(\tau) d\tau + K_d \frac{de(t)}{dt}
    \end{equation}
    où :
    \begin{itemize}
        \item $u(t)$ est le signal de commande
        \item $e(t)$ est l'erreur (différence entre la consigne et la mesure)
        \item $K_p$, $K_i$ et $K_d$ sont respectivement les gains proportionnel, intégral et dérivé du PID
    \end{itemize}
}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{images/schema_drone.png}
...
\begin{equation}
F_{p} = 4 * KP * \left(\frac{2 \pi}{60}\right)^{2} * u^{2}
\end{equation}
