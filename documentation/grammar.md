...
Chips grammar is inspired from C but intends to be a functional language by essence where each declared functional block is to be connected to others by flows of data.
