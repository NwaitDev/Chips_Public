...
public:
    ...
    virtual void hello() override; // {std::cout << "hello from c_assignment_node\n";}
...
public:
    ...
    void accept(chips_visitor& visitor);
    virtual void hello() override; // {std::cout << "hello from at_node\n";}
...
public:
    ...
    void append(std::unique_ptr<c_statement_node> sttmt){sstatements.push_back(std::move(sttmt));}

    void accept(chips_visitor& visitor);
    virtual void hello() override; // {std::cout << "hello from c_statements_node\n";}
};
...
public:
    ...
    void accept(chips_visitor& visitor);
    virtual void hello() override; // {std::cout << "hello from c_loop_node\n";}
};
...
public:
    ...
    void accept(chips_visitor& visitor);
    virtual void hello() override;// {std::cout << "hello from c_if_node\n";}
};
...
public:
    ...
    void accept(chips_visitor& visitor);
    virtual void hello() override;// {std::cout << "hello from c_if_else_node\n";}
};
