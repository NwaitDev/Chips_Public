...
{
public:
    virtual S_STATEMENT_TYPE get_statement_type() const = 0;
};

class s_statements_node : public s_statement_node
{
private:
...
public:
    ...
    void accept(chips_visitor &visitor) const {};
...
public:
    ...
    S_STATEMENT_TYPE get_statement_type() const override { return S_FUNC_BLOCK_INST_ST; }
    std::string get_ident1() { return ident1; }
...
public:
    ...
    S_STATEMENT_TYPE get_statement_type() const override { return S_EXPR_PLUG_ST; }
...
public:
    ...
    S_STATEMENT_TYPE get_statement_type() const override { return S_LINK_ST; }
...
public:
    ...
    S_STATEMENT_TYPE get_statement_type() const override { return S_IMPLEMENTS_ST; }
    std::string get_ident1() { return ident1; }
