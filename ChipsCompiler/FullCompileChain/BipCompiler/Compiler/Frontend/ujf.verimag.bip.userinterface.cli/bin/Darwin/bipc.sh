...
java -Djava.library.path=${ROOT}/lib -Dbip.compiler.backends="$BACKENDS" -Dbip.compiler.filters="$FILTERS" -ea -cp $LOCAL_CP ujf.verimag.bip.userinterface.cli.Runner $*
