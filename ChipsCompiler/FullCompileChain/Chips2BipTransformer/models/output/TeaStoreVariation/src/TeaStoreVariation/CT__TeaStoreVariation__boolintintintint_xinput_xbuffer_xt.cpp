...
) : ComponentItf(name, COMPOUND), Compound(name), _comp_decl__redirection_bd(_comp_decl__redirection_bd), _comp_decl__maxRequests_bd(_comp_decl__maxRequests_bd), _comp_decl__userID_bd(_comp_decl__userID_bd), _comp_decl__nbDataToFetch_bd(_comp_decl__nbDataToFetch_bd), _comp_decl__nbAnsweredReqs_bd(_comp_decl__nbAnsweredReqs_bd), _conn_decl__boolintintintint_input_connector(_conn_decl__boolintintintint_input_connector), _eport_decl__redirection_exin_cepd(_eport_decl__redirection_exin_cepd), _eport_decl__maxRequests_exin_cepd(_eport_decl__maxRequests_exin_cepd), _eport_decl__userID_exin_cepd(_eport_decl__userID_exin_cepd), _eport_decl__nbDataToFetch_exin_cepd(_eport_decl__nbDataToFetch_exin_cepd), _eport_decl__nbAnsweredReqs_exin_cepd(_eport_decl__nbAnsweredReqs_exin_cepd), _eport_decl__one_cepd(_eport_decl__one_cepd) {
    this->addComponent(_comp_decl__redirection_bd);
    this->addComponent(_comp_decl__maxRequests_bd);
    this->addComponent(_comp_decl__userID_bd);
    this->addComponent(_comp_decl__nbDataToFetch_bd);
    this->addComponent(_comp_decl__nbAnsweredReqs_bd);
    this->addConnector(_conn_decl__boolintintintint_input_connector);
    this->addPort(_eport_decl__redirection_exin_cepd);
    this->addPort(_eport_decl__maxRequests_exin_cepd);
    this->addPort(_eport_decl__userID_exin_cepd);
    this->addPort(_eport_decl__nbDataToFetch_exin_cepd);
    this->addPort(_eport_decl__nbAnsweredReqs_exin_cepd);
