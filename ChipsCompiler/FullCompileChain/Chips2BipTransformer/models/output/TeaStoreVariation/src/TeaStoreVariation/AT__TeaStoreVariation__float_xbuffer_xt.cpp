...
bool AT__TeaStoreVariation__float_xbuffer_xt::atDATA_RECEIVING () const {
    return __statesbv[ 0/(8*sizeof(int))] & 1<< (0%(8*sizeof(int)));
}

bool AT__TeaStoreVariation__float_xbuffer_xt::toDATA_RECEIVING () {
    if (atDATA_RECEIVING()) return false;
    __statesbv[ 0/(8*sizeof(int))] |= 1<< (0%(8*sizeof(int)));
    return true;
}

bool AT__TeaStoreVariation__float_xbuffer_xt::fromDATA_RECEIVING () {
    if (!atDATA_RECEIVING()) return false;
    __statesbv[ 0/(8*sizeof(int))] &= ~(1<< (0%(8*sizeof(int))));
    return true;
}

bool AT__TeaStoreVariation__float_xbuffer_xt::atDATA_SENDING () const {
    return __statesbv[ 1/(8*sizeof(int))] & 1<< (1%(8*sizeof(int)));
}

bool AT__TeaStoreVariation__float_xbuffer_xt::toDATA_SENDING () {
    if (atDATA_SENDING()) return false;
    __statesbv[ 1/(8*sizeof(int))] |= 1<< (1%(8*sizeof(int)));
    return true;
}

bool AT__TeaStoreVariation__float_xbuffer_xt::fromDATA_SENDING () {
    if (!atDATA_SENDING()) return false;
    __statesbv[ 1/(8*sizeof(int))] &= ~(1<< (1%(8*sizeof(int))));
    return true;
}

AT__TeaStoreVariation__float_xbuffer_xt::AT__TeaStoreVariation__float_xbuffer_xt(const string &name , AtomIPort__TeaStoreVariation__float_xport_xt &_iport_decl__in, AtomIPort__TeaStoreVariation__float_xport_xt &_iport_decl__out
                         
                         , AtomEPort__TeaStoreVariation__float_xport_xt &_eport_decl__exp_in, AtomEPort__TeaStoreVariation__float_xport_xt &_eport_decl__exp_out
                         
                         ) :  ComponentItf(name, ATOM), Atom(name) , _iport_decl__in(_iport_decl__in), _iport_decl_pv__in(), _iport_decl__out(_iport_decl__out), _iport_decl_pv__out(_id__float_data), _eport_decl__exp_in(_eport_decl__exp_in), _eport_decl__exp_out(_eport_decl__exp_out), _transguard__1(false), _transguard__2(false), __previous(-1) {
...
BipError& AT__TeaStoreVariation__float_xbuffer_xt::execute(PortValue &portValue) {
...
BipError& AT__TeaStoreVariation__float_xbuffer_xt::execute(AtomExternalPort &port) {
   BipError *ret = &BipError::NoError;
...
BipError& AT__TeaStoreVariation__float_xbuffer_xt::initialize() {
    BipError *ret = &BipError::NoError;
...
string AT__TeaStoreVariation__float_xbuffer_xt::toString() const {
    ostringstream oss;
    bool first=true;
    if (atDATA_RECEIVING()) {
      if (!first) oss << ", ";
    ...
    oss << "float_data=" << _id__float_data;

    return oss.str(); 
}

BipError& AT__TeaStoreVariation__float_xbuffer_xt::update() {
    BipError *ret = &BipError::NoError;
...
BipError &AT__TeaStoreVariation__float_xbuffer_xt::executeInternalTransitions() {
    BipError &ret = BipError::NoError;
...
AT__TeaStoreVariation__float_xbuffer_xt::~AT__TeaStoreVariation__float_xbuffer_xt() {
}
