...
CT__TeaStoreVariation__ServerMachine_xcompoundtype::CT__TeaStoreVariation__ServerMachine_xcompoundtype (const string &name, AT__TeaStoreVariation__ServerMachine_xcore &_comp_decl__core
,
...
) : ComponentItf(name, COMPOUND), Compound(name), _comp_decl__core(_comp_decl__core), _comp_decl__ServerMachine_input_buffer_buffercompounddecl(_comp_decl__ServerMachine_input_buffer_buffercompounddecl), _comp_decl__ServerMachine_output_buffer_buffercompounddecl(_comp_decl__ServerMachine_output_buffer_buffercompounddecl), _conn_decl__input__to__core_cd(_conn_decl__input__to__core_cd), _conn_decl__core__to__output_cd(_conn_decl__core__to__output_cd), _comp_param__starts_componentdataparameterdeclaration(_comp_param__starts_componentdataparameterdeclaration) {
    this->addComponent(_comp_decl__core);
    this->addComponent(_comp_decl__ServerMachine_input_buffer_buffercompounddecl);
    this->addComponent(_comp_decl__ServerMachine_output_buffer_buffercompounddecl);
    this->addConnector(_conn_decl__input__to__core_cd);
    this->addConnector(_conn_decl__core__to__output_cd);
}

CT__TeaStoreVariation__ServerMachine_xcompoundtype::~CT__TeaStoreVariation__ServerMachine_xcompoundtype() {
}
