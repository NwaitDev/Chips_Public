#ifndef TEASTOREVARIATION_CONNT____TEASTOREVARIATION____FLOW__XBOOL__XT_HPP_
#define TEASTOREVARIATION_CONNT____TEASTOREVARIATION____FLOW__XBOOL__XT_HPP_
...
#include <TeaStoreVariation/InterV__TeaStoreVariation__flow_xbool_xt.hpp>

class ConnT__TeaStoreVariation__flow_xbool_xt : public Connector {
public:
    ConnT__TeaStoreVariation__flow_xbool_xt(const string &name, QPR__TeaStoreVariation__bool_xport_xt &s, QPR__TeaStoreVariation__bool_xport_xt &r);
    virtual ~ConnT__TeaStoreVariation__flow_xbool_xt();
...
private:
    QPR__TeaStoreVariation__bool_xport_xt &s;
    QPR__TeaStoreVariation__bool_xport_xt &r;


    // Interactions
    // build for s,r
    Inter__TeaStoreVariation__flow_xbool_xt *_i__s_r;



    mutable vector<Interaction *> definedInteractions;
};
#endif // TEASTOREVARIATION_CONNT____TEASTOREVARIATION____FLOW__XBOOL__XT_HPP_
