#ifndef INCLUDE_TEASTOREVARIATION_INTER____TEASTOREVARIATION____FLOW__XINTINT__XT_HPP_
#define INCLUDE_TEASTOREVARIATION_INTER____TEASTOREVARIATION____FLOW__XINTINT__XT_HPP_
...
class Port;
class ConnT__TeaStoreVariation__flow_xintint_xt;

class PT__TeaStoreVariation__intint_xport_xt;

class Inter__TeaStoreVariation__flow_xintint_xt :  public Interaction {
public:
    virtual ~Inter__TeaStoreVariation__flow_xintint_xt();
    ...
    Inter__TeaStoreVariation__flow_xintint_xt(const ConnT__TeaStoreVariation__flow_xintint_xt &connector);
    Inter__TeaStoreVariation__flow_xintint_xt(const ConnT__TeaStoreVariation__flow_xintint_xt &connector, const vector<Port *> &ports);
    Inter__TeaStoreVariation__flow_xintint_xt(const ConnT__TeaStoreVariation__flow_xintint_xt &connector, bool s, bool r);
...
inline
vector<Port *>::size_type Inter__TeaStoreVariation__flow_xintint_xt::findPort(const Port *p) const {
...
inline bool Inter__TeaStoreVariation__flow_xintint_xt::en(size_t index) const {
    return involvedPorts.test(index);
}

inline bool Inter__TeaStoreVariation__flow_xintint_xt::isDefined() const {
    if (refresh_defined) {
...
inline bool Inter__TeaStoreVariation__flow_xintint_xt::hasSubDefined() const {
    return isDefined();
}

inline
bool Inter__TeaStoreVariation__flow_xintint_xt::hasPorts() const {
    return involvedPorts.any();
}

inline
void Inter__TeaStoreVariation__flow_xintint_xt::addPort(Port &port){
...
inline
void Inter__TeaStoreVariation__flow_xintint_xt::removePort(Port &port){
    const vector<Port *>::size_type post_shift = findPort(&port);
...
inline
bool Inter__TeaStoreVariation__flow_xintint_xt::nonEmptyIntersection(const Interaction &interaction) const {
    bool ret = false;
...
#endif // INCLUDE_TEASTOREVARIATION_INTER____TEASTOREVARIATION____FLOW__XINTINT__XT_HPP_
