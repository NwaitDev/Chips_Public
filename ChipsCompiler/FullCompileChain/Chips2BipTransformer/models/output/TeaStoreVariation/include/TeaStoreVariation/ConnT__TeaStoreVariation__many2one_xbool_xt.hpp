#ifndef TEASTOREVARIATION_CONNT____TEASTOREVARIATION____MANY2ONE__XBOOL__XT_HPP_
#define TEASTOREVARIATION_CONNT____TEASTOREVARIATION____MANY2ONE__XBOOL__XT_HPP_
...
class ConnT__TeaStoreVariation__many2one_xbool_xt : public Connector {
public:
    ConnT__TeaStoreVariation__many2one_xbool_xt(const string &name, QPR__TeaStoreVariation__bool_xport_xt &p0_cppd, ConnPort__TeaStoreVariation__bool_xport_xt &r_exported_port);
    virtual ~ConnT__TeaStoreVariation__many2one_xbool_xt();
...
private:
    ...
    ConnPort__TeaStoreVariation__bool_xport_xt &r_exported_port;

    // Interactions
    // build for p0_cppd
    Inter__TeaStoreVariation__many2one_xbool_xt *_i__p0_cppd;



    mutable vector<Interaction *> definedInteractions;
};
#endif // TEASTOREVARIATION_CONNT____TEASTOREVARIATION____MANY2ONE__XBOOL__XT_HPP_
