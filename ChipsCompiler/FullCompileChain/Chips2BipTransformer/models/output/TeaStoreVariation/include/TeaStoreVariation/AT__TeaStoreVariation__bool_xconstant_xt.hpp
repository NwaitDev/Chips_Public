#ifndef TEASTOREVARIATION_AT____TEASTOREVARIATION____BOOL__XCONSTANT__XT_HPP_
#define TEASTOREVARIATION_AT____TEASTOREVARIATION____BOOL__XCONSTANT__XT_HPP_
...
class AT__TeaStoreVariation__bool_xconstant_xt : public Atom {
private:
   // internal ports & associated port values
    AtomIPort__TeaStoreVariation__bool_xport_xt &_iport_decl__output_aipd;
    PV__TeaStoreVariation__bool_xport_xt _iport_decl_pv__output_aipd;

    // exported ports
    AtomEPort__TeaStoreVariation__bool_xport_xt &_eport_decl__output_aepd;
public:
    AT__TeaStoreVariation__bool_xconstant_xt(const string &name , AtomIPort__TeaStoreVariation__bool_xport_xt &_iport_decl__output_aipd
                             
                             , AtomEPort__TeaStoreVariation__bool_xport_xt &_eport_decl__output_aepd
                             
                             );
    virtual ~AT__TeaStoreVariation__bool_xconstant_xt();
...
protected:
    ...
    chips_bool _id__bool_value_aidd;
...
#endif // TEASTOREVARIATION_AT____TEASTOREVARIATION____BOOL__XCONSTANT__XT_HPP_
