#ifndef TEASTOREVARIATION_CONNT____TEASTOREVARIATION____FLOW__XINT__XT_HPP_
#define TEASTOREVARIATION_CONNT____TEASTOREVARIATION____FLOW__XINT__XT_HPP_
...
class ConnT__TeaStoreVariation__flow_xint_xt : public Connector {
public:
    ConnT__TeaStoreVariation__flow_xint_xt(const string &name, QPR__TeaStoreVariation__int_xport_xt &s, QPR__TeaStoreVariation__int_xport_xt &r);
    virtual ~ConnT__TeaStoreVariation__flow_xint_xt();
...
private:
    QPR__TeaStoreVariation__int_xport_xt &s;
    QPR__TeaStoreVariation__int_xport_xt &r;


    // Interactions
    // build for s,r
    Inter__TeaStoreVariation__flow_xint_xt *_i__s_r;



    mutable vector<Interaction *> definedInteractions;
};
#endif // TEASTOREVARIATION_CONNT____TEASTOREVARIATION____FLOW__XINT__XT_HPP_
