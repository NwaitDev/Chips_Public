#ifndef TEASTOREVARIATION_AT____TEASTOREVARIATION____AUTHENTICATOR__XCORE_HPP_
#define TEASTOREVARIATION_AT____TEASTOREVARIATION____AUTHENTICATOR__XCORE_HPP_
...
class AT__TeaStoreVariation__Authenticator_xcore : public Atom {
private:
   // internal ports & associated port values
    ...
    AtomIPort__TeaStoreVariation__bool_xport_xt &_iport_decl__recv_aipd;
    PV__TeaStoreVariation__bool_xport_xt _iport_decl_pv__recv_aipd;

    // exported ports
    AtomEPort__TeaStoreVariation__bool_xport_xt &_eport_decl__send_aepd;
    AtomEPort__TeaStoreVariation__bool_xport_xt &_eport_decl__recv_aepd;
public:
    ...
    virtual ~AT__TeaStoreVariation__Authenticator_xcore();
...
#endif // TEASTOREVARIATION_AT____TEASTOREVARIATION____AUTHENTICATOR__XCORE_HPP_
