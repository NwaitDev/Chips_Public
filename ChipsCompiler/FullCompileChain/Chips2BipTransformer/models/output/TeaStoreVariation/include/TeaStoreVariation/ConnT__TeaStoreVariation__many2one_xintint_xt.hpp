#ifndef TEASTOREVARIATION_CONNT____TEASTOREVARIATION____MANY2ONE__XINTINT__XT_HPP_
#define TEASTOREVARIATION_CONNT____TEASTOREVARIATION____MANY2ONE__XINTINT__XT_HPP_
...
#include <TeaStoreVariation/QPR__TeaStoreVariation__intint_xport_xt.hpp>
#include <TeaStoreVariation/ConnPort__TeaStoreVariation__intint_xport_xt.hpp>
#include <TeaStoreVariation/InterV__TeaStoreVariation__many2one_xintint_xt.hpp>

class ConnT__TeaStoreVariation__many2one_xintint_xt : public Connector {
public:
    ConnT__TeaStoreVariation__many2one_xintint_xt(const string &name, QPR__TeaStoreVariation__intint_xport_xt &p0_cppd, QPR__TeaStoreVariation__intint_xport_xt &p1_cppd, ConnPort__TeaStoreVariation__intint_xport_xt &r_exported_port);
    virtual ~ConnT__TeaStoreVariation__many2one_xintint_xt();
...
private:
    QPR__TeaStoreVariation__intint_xport_xt &p0_cppd;
    QPR__TeaStoreVariation__intint_xport_xt &p1_cppd;

    ConnPort__TeaStoreVariation__intint_xport_xt &r_exported_port;

    // Interactions
    // build for p0_cppd,p1_cppd
    Inter__TeaStoreVariation__many2one_xintint_xt *_i__p0_cppd_p1_cppd;



    mutable vector<Interaction *> definedInteractions;
};
#endif // TEASTOREVARIATION_CONNT____TEASTOREVARIATION____MANY2ONE__XINTINT__XT_HPP_
