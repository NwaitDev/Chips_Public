#ifndef TEASTOREVARIATION_CONNT____TEASTOREVARIATION____ONE2MANY__XINT__XT_HPP_
#define TEASTOREVARIATION_CONNT____TEASTOREVARIATION____ONE2MANY__XINT__XT_HPP_
...
#include <TeaStoreVariation/QPR__TeaStoreVariation__int_xport_xt.hpp>
#include <TeaStoreVariation/ConnPort__TeaStoreVariation__int_xport_xt.hpp>
#include <TeaStoreVariation/InterV__TeaStoreVariation__one2many_xint_xt.hpp>

class ConnT__TeaStoreVariation__one2many_xint_xt : public Connector {
public:
    ConnT__TeaStoreVariation__one2many_xint_xt(const string &name, QPR__TeaStoreVariation__int_xport_xt &p0_cppd, ConnPort__TeaStoreVariation__int_xport_xt &s_exported_port);
    virtual ~ConnT__TeaStoreVariation__one2many_xint_xt();
...
private:
    QPR__TeaStoreVariation__int_xport_xt &p0_cppd;

    ConnPort__TeaStoreVariation__int_xport_xt &s_exported_port;

    // Interactions
    // build for p0_cppd
    Inter__TeaStoreVariation__one2many_xint_xt *_i__p0_cppd;



    mutable vector<Interaction *> definedInteractions;
};
#endif // TEASTOREVARIATION_CONNT____TEASTOREVARIATION____ONE2MANY__XINT__XT_HPP_
