#ifndef TEASTOREVARIATION_AT____TEASTOREVARIATION____SERVERMACHINE__XCORE_HPP_
#define TEASTOREVARIATION_AT____TEASTOREVARIATION____SERVERMACHINE__XCORE_HPP_
...
#include <TeaStoreVariation/AtomIPort__TeaStoreVariation__boolintintint_xport_xt.hpp>
#include <TeaStoreVariation/AtomIPort__TeaStoreVariation__intintint_xport_xt.hpp>


#include <TeaStoreVariation/AtomEPort__TeaStoreVariation__boolintintint_xport_xt.hpp>
#include <TeaStoreVariation/AtomEPort__TeaStoreVariation__intintint_xport_xt.hpp>
...
class AT__TeaStoreVariation__ServerMachine_xcore : public Atom {
private:
   // internal ports & associated port values
    ...
    AtomIPort__TeaStoreVariation__boolintintint_xport_xt &_iport_decl__send_aipd;
    PV__TeaStoreVariation__boolintintint_xport_xt _iport_decl_pv__send_aipd;
    AtomIPort__TeaStoreVariation__intintint_xport_xt &_iport_decl__recv_aipd;
    PV__TeaStoreVariation__intintint_xport_xt _iport_decl_pv__recv_aipd;

    // exported ports
    AtomEPort__TeaStoreVariation__boolintintint_xport_xt &_eport_decl__send_aepd;
    AtomEPort__TeaStoreVariation__intintint_xport_xt &_eport_decl__recv_aepd;
public:
    ...
    virtual ~AT__TeaStoreVariation__ServerMachine_xcore();
...
protected:
    ...
    chips_int _id__wpServed_aidd;
    chips_int _id__maxNbData_aidd;
    chips_int _id__fromInternet_aidd;
    chips_int _id__httpResponse_aidd;
    chips_int _id__currentRequest_aidd;
    chips_bool _id__requestFound_aidd;
    chips_int _id__requestList_aidd;
    chips_int _id__nbDataToOutput_aidd;
    chips_int _id__userIDToOutput_aidd;
    chips_bool _id__userAuthToOutput_aidd;
    chips_bool _id__userAuth_aidd;
    chips_int _id__nbData_aidd;
    chips_int _id__userID_aidd;
    chips_int _id__fromServerToInternet_aidd;
...
#endif // TEASTOREVARIATION_AT____TEASTOREVARIATION____SERVERMACHINE__XCORE_HPP_
