#ifndef TEASTOREVARIATION_CONNT____TEASTOREVARIATION____FLOW__XBOOLINTINT__XT_HPP_
#define TEASTOREVARIATION_CONNT____TEASTOREVARIATION____FLOW__XBOOLINTINT__XT_HPP_
...
#include <TeaStoreVariation/InterV__TeaStoreVariation__flow_xboolintint_xt.hpp>

class ConnT__TeaStoreVariation__flow_xboolintint_xt : public Connector {
public:
    ConnT__TeaStoreVariation__flow_xboolintint_xt(const string &name, QPR__TeaStoreVariation__boolintint_xport_xt &s, QPR__TeaStoreVariation__boolintint_xport_xt &r);
    virtual ~ConnT__TeaStoreVariation__flow_xboolintint_xt();
...
private:
    QPR__TeaStoreVariation__boolintint_xport_xt &s;
    QPR__TeaStoreVariation__boolintint_xport_xt &r;


    // Interactions
    // build for s,r
    Inter__TeaStoreVariation__flow_xboolintint_xt *_i__s_r;



    mutable vector<Interaction *> definedInteractions;
};
#endif // TEASTOREVARIATION_CONNT____TEASTOREVARIATION____FLOW__XBOOLINTINT__XT_HPP_
