#ifndef INCLUDE_TEASTOREVARIATION_INTER____TEASTOREVARIATION____MANY2ONE__XBOOLINTINT__XT_HPP_
#define INCLUDE_TEASTOREVARIATION_INTER____TEASTOREVARIATION____MANY2ONE__XBOOLINTINT__XT_HPP_
...
class Inter__TeaStoreVariation__many2one_xboolintint_xt :  public Interaction {
public:
    virtual ~Inter__TeaStoreVariation__many2one_xboolintint_xt();
    ...
    Inter__TeaStoreVariation__many2one_xboolintint_xt(const ConnT__TeaStoreVariation__many2one_xboolintint_xt &connector);
    Inter__TeaStoreVariation__many2one_xboolintint_xt(const ConnT__TeaStoreVariation__many2one_xboolintint_xt &connector, const vector<Port *> &ports);
    Inter__TeaStoreVariation__many2one_xboolintint_xt(const ConnT__TeaStoreVariation__many2one_xboolintint_xt &connector, bool p0_cppd, bool p1_cppd, bool p2_cppd);
...
inline
vector<Port *>::size_type Inter__TeaStoreVariation__many2one_xboolintint_xt::findPort(const Port *p) const {
...
inline bool Inter__TeaStoreVariation__many2one_xboolintint_xt::en(size_t index) const {
    return involvedPorts.test(index);
}

inline bool Inter__TeaStoreVariation__many2one_xboolintint_xt::isDefined() const {
    if (refresh_defined) {
...
inline bool Inter__TeaStoreVariation__many2one_xboolintint_xt::hasSubDefined() const {
    return isDefined();
}

inline
bool Inter__TeaStoreVariation__many2one_xboolintint_xt::hasPorts() const {
    return involvedPorts.any();
}

inline
void Inter__TeaStoreVariation__many2one_xboolintint_xt::addPort(Port &port){
...
inline
void Inter__TeaStoreVariation__many2one_xboolintint_xt::removePort(Port &port){
    const vector<Port *>::size_type post_shift = findPort(&port);
...
inline
bool Inter__TeaStoreVariation__many2one_xboolintint_xt::nonEmptyIntersection(const Interaction &interaction) const {
    bool ret = false;
...
#endif // INCLUDE_TEASTOREVARIATION_INTER____TEASTOREVARIATION____MANY2ONE__XBOOLINTINT__XT_HPP_
